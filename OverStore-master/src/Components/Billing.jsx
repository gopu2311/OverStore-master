...
const Billing = () => {
  const GetUrlData = async () => {
    ...
    const data = await axios.get("http://localhost:5000/detail/customer");
  ...
  const GetProductData = async () => {
    // const data = await axios.get("https://fakestoreapi.com/products");
    const data = await axios.get("http://localhost:5000/detail/product");
  ...
  const GetBillData = async () => {
    ...
    axios
      .post("http://localhost:5000/detail/bill", formData, {
        headers: {
          Accept: "auth",
